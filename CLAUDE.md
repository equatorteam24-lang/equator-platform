...
✅ **Міграція виконана.** Архітектура Модель 2 працює, `equator-app.com` живе на новому мультитенантному проекті.

### Vercel проекти (актуальний список)

| Проект | Призначення | Root Directory |
|--------|-------------|----------------|
| `equator-platform` | multi-tenant: всі клієнтські сайти | `apps/platform` |
| `equator-platform-super-admin` | admin.equator.agency | `apps/super-admin` |

Інших проектів для клієнтів НЕ створюємо — нові клієнти = папки всередині `equator-platform`.
