    ...
    <div style={{ fontFamily: "'IBM Plex Sans', sans-serif", color: "#0F0F0F", background: "#F5F2ED" }}>
      ...
      <section style={{
        ...
        <div style={{ position: "relative", zIndex: 2, padding: "0 clamp(1.5rem, 5vw, 6rem) clamp(4rem, 8vw, 8rem)" }}>
          {/* Stat ticker at top */}
          <div style={{
            position: "absolute", top: "clamp(100px, 15vh, 140px)", left: 0, right: 0,
            overflow: "hidden", borderTop: "1px solid rgba(212,168,67,0.15)",
            ...
            <div className="marquee-track">
              {[...Array(4)].map((_, i) => (
                <div key={i} style={{ display: "flex", gap: 60, paddingRight: 60 }}>
                  <span className="mono-label" style={{ color: "rgba(245,242,237,0.3)", whiteSpace: "nowrap" }}>
                    Україна та Європа
                  </span>
...
function ServiceCard({ num, title, desc, img, delay }) {
